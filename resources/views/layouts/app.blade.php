    ...
    <div id="app">
                        ...
                        @auth
                            <li class="nav-item">
                                <a href=" {{route('users.notifications')}}" class="nav-link">
                                    <span class="ml-2 badge badge-info text-white">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    @auth
                        <a href="{{route('discussions.create')}}" class="btn btn-info text-white">Add Discussions</a>                      
                        @else 
                        <a href="{{route('login')}}" class="btn btn-info text-white">Sign-in to Create Discussion</a>                      
                    @endauth
